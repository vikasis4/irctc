...
function Navbar() {
    ...
    return (
        <div className='bg-primary h-1/4 w-full p-4 flex gap-4 justify-between z-50 items-center pb-12'>
            ...
            <div className='flex gap-4'>
                ...
                <img src={user} alt="user" className='h-8 w-8' onClick={handleClick} />
            </div>
        </div>
    )
}
